...
$$('.btn-ss-pra-operasi-detail').on('click', function () {
 ...
 mainView.router.loadPage('1-ss-pra-operasi-detail.html');
...
$$.ajax({
    url: myApp.getWebApi('APPS-GET-Active-Seismic-IsShowPreOps'),
    method: 'POST',
    data: {},
    timeout: (5 * 60 * 1000),
...
document.getElementById("data-project-pra").innerHTML = dtProjectAll.join(" ");

$$('.btn-detail-pra-pro').on('click', function () {
