...
var activePage=mainView.activePage.view.activePage.name;	
...
$$.ajax({
    url: myApp.getWebApi('APPS-GET-Active-Well-OnDrill'),
    method: 'POST',
    data: {},
    timeout: (5 * 60 * 1000),
...
document.getElementById("data-well").innerHTML = dtWellAll.join(" ");
