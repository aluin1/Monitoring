...
///load service Page  
myApp.onPageInit("1-ss-survey-result", function(page){
	/*
...
$$('.btn-survey-result-detail').on('click', function () {
 
 mainView.router.loadPage('1-ss-survey-result-detail.html');
...
$$.ajax({
    url: myApp.getWebApi('APPS-GET-Active-Seismic-IsShowResult'),
    method: 'POST',
    data: {},
    timeout: (5 * 60 * 1000),
...
document.getElementById("data-project-result").innerHTML = dtProjectAllResult.join(" ");
