...
///load service Page  
myApp.onPageInit("1-ed-pra-operasi", function(page){
...
$$('.btn-ed-pra-operasi-detail').on('click', function () {
 
 mainView.router.loadPage('1-ed-pra-operasi-detail.html');
...
$$.ajax({
    url: myApp.getWebApi('APPS-GET-Active-Well-PreDrill'),
    method: 'POST',
    data: {},
    timeout: (5 * 60 * 1000),
...
document.getElementById("data-well-pra").innerHTML = dtWellAll.join(" ");

$$('.btn-detail-pra').on('click', function () {
